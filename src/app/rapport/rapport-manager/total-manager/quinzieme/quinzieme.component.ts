...
@Component({
  selector: 'app-quinzieme',
  templateUrl: './quinzieme.component.html',
  styleUrls: ['./quinzieme.component.scss']
})
export class QuinziemeComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  rapport_total: ObjectRapport_quinzieme[]=[];
  annee!: number;
  ...
  reloadRapport(){
    this.rapportService.rapportQuinziemeTotal(this.annee).subscribe(data=>{
