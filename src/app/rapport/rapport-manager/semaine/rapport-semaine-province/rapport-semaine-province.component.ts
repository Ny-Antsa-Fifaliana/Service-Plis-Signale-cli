...
@Component({
  selector: 'app-rapport-semaine-province',
  templateUrl: './rapport-semaine-province.component.html',
  styleUrls: ['./rapport-semaine-province.component.scss']
})
export class RapportSemaineProvinceComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  rapport_depotprovinces: ObjectRapport_semaine[]=[];
  ...
  reloadRapport(){
    this.rapportService.rapportSemaineDepotprovince(this.idDepotprovince).subscribe(data=>{
