...
@Component({
  selector: 'app-rapport-semaine-zone',
  templateUrl: './rapport-semaine-zone.component.html',
  styleUrls: ['./rapport-semaine-zone.component.scss']
})
export class RapportSemaineZoneComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  rapport_depotzone: ObjectRapport_semaine[]=[];
  idDepot!: number;
  ...
  reloadRapport(){
    this.rapportService.rapportSemaineDepotzone(this.idDepot).subscribe(data=>{
