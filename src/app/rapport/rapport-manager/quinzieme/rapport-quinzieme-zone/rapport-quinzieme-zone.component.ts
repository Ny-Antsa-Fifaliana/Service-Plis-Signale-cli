...
@Component({
  selector: 'app-rapport-quinzieme-zone',
  templateUrl: './rapport-quinzieme-zone.component.html',
  styleUrls: ['./rapport-quinzieme-zone.component.scss']
})
export class RapportQuinziemeZoneComponent implements OnInit, OnDestroy, AfterViewInit  {
  dtOptions: any={}; 
  ...
  rapport_depotzone: ObjectRapport_quinzieme[]=[];
  idDepot!: number;
  ...
  reloadRapport(){
    this.rapportService.rapportQuinziemeDepotzone(this.idDepot).subscribe(data=>{
